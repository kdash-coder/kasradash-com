...
**→ Before you dive in, make sure you’ve read [What Is SEO](/seo/) and [How SEO Works](/seo/learn/how-seo-works/), this article builds directly on those concepts.**
...
**→ Learn more about how Google processes queries in [How Search Engines Work](/seo/learn/how-search-engines-work/) and see how it fits into the [Three Pillars of SEO](/seo/learn/the-3-pillars-of-seo/).**
...
→ To understand how keywords fit within algorithmic systems, see [**SEO Ranking Factors**](/seo/learn/seo-ranking-factors/) and [**What Are Search Engine Algorithms**](/seo/learn/what-are-search-engine-algorithms/).
...
→ Explore definitions in the [**SEO Glossary**](/seo/learn/seo-glossary/) and download the [**Keyword Research Template**](/seo/seo-frameworks/keyword-research-template/) to plan your targeting.
...
1. **Informational** → “what is SEO”, users seek knowledge.
2. **Navigational** → “Ahrefs login”, users seek a specific brand or site.
3. **Commercial Investigation** → “best SEO tools 2025”, users compare options.
4. **Transactional** → “buy SEO course online”, users are ready to convert.
...
**→ Learn how intent drives modern optimisation in [AI & SEO](/seo/ai-and-seo/) and apply it through [SEO Strategy for Beginners](/seo/learn/seo-strategy-for-beginners/).**
...
→ Apply this approach in [**Content SEO**](/seo/content-seo/), review credibility signals in **E-E-A-T**, and operationalise it using the [**SEO Checklist**](/seo/seo-frameworks/seo-checklist/).
...
1. **Keyword Cannibalisation** → Targeting the same term across multiple pages, causing internal competition.
2. **Ignoring Search Intent** → Writing content that doesn’t satisfy user needs.
3. **Overusing Keywords** → “Keyword stuffing” lowers readability and trust.
4. **Focusing Only on Volume** → High-traffic keywords often convert poorly.
5. **Neglecting Semantic Relevance** → Ignoring related terms weakens topical authority.

→ Learn how to fix cannibalisation in *Content Audits* and see realistic pacing in [**How Long Does SEO Take**](/seo/learn/how-long-does-seo-take/).
